...
if( !isset( $_GET['name'] ) ) {
	$msg = wfMsg('welcome').'<br /><br />
		<form action="http://toolserver.org/~soxred93/simplecount/index.php" method="get">
	...
	foreach( $messages as $lang => $msgs ) {
		$msg .= "<li><a href=\"http://toolserver.org/~soxred93/simplecount/index.php?uselang=$lang\">".$canonical[$lang]." ";
